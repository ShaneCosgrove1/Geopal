Geopal.Debug.setWebContentsDebuggingEnabled(true);
    ...
    var pumpHours = 'job_workflow_1391433';     // Pump 1 Hours
    var pumpAmps = 'job_workflow_1391434';      // Pump 1 Amps
...
function loadDoc() {
    ...
    xhttp.open("GET", "https://iot.geopalsolutions.com/iot/c1225_getpumphistory?assetID=" + assetID + "&pumpHours=" + pumpHours + "&pumpAmps=" + pumpAmps, true);                // Change URL to match IoT call
    xhttp.send();
