...
var assetIdentifier = job.asset.identifier;
if (assetIdentifier.length > 4){
  //asset = asset.substring(0,5);
  assetIdentifier = assetIdentifier.replace(/\_.+/g, '');  //match '_'followed by a letter and everything after, replace with blanks  Eliminates error cause by using asset like C632_1 @shanecosgrove
}
var asset = Geopal.Asset.getByIdentifier(job.asset.identifier);
...
function logto5(name, val) {
  ...
  Geopal.Log.setExtraField5(JSON.stringify(extrafield5));
};
...
if (assetIdentifier) {
  ...
  logto5('Project Folder ID: ' + projID);
  // ///////////////////////
  // SEND FILE
  // //////////////////////
